...
define([
    ...
    'underscore'
        ...
        app.controller('combochartCtrl', function ($scope, $rootScope, $q, $translate) {
            ...
            $scope.app.getObjectProperties(_idObject).then(function (model) {
                ...
                function getColor() {
                    model.getEffectiveProperties().then(function (i) {
                        ...
                        //alert($scope.colorBurbuja + ' :: ' + $scope.modoColor)
                        ...
                        if ($scope.colorBurbuja == 'byMultiple' && $scope.modoColor == false) {
