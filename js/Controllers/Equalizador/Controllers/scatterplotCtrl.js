...
define([
    ...
    'underscore'
        ...
        app.controller('scatterplotCtrl', function ($scope, $rootScope, $q, $translate) {
            ...
            $scope.app.getObjectProperties(_idObject).then(function (model) {
                ...
                function getEtiquetaNavegacion(_idObject) {
                    model.getEffectiveProperties().then(function (i) {
                        var _propiedades = i;
                ...
                function getShowLables(_idObject) {
                    model.getEffectiveProperties().then(function (i) {
                        var _propiedades = i;
                ...
                getMedidas();
                getScalecolor();
                getEtiquetaNavegacion(_idObject);
                getShowLables(_idObject);
                getBurbujas();
                getColor();
                getLeyendas();
                getPosicionLeyenda();
