...
define([
    ...
    'underscore',
        ...
        app.controller('boxplotCtrl', function ($scope, $rootScope, $q, $translate) {
            ...
            $scope.app.getObjectProperties(_idObject).then(function (model) {
                console.log(model);
                $scope.ARRDIMENSIONS = model.properties.boxplotDef.qHyperCubeDef.qDimensions;
                $scope.ARRDIMENSIONSALTERNATIVES = model.properties.boxplotDef.qHyperCubeDef.qLayoutExclude.qHyperCubeDef.qDimensions;
                $scope.ALLDIMENSIONS = $scope.ARRDIMENSIONS.concat($scope.ARRDIMENSIONSALTERNATIVES);

                $scope.ARRMEASURES = model.properties.boxplotDef.qHyperCubeDef.qMeasures;
                $scope.ARRMEASURESALTERNATIVES = model.properties.boxplotDef.qHyperCubeDef.qLayoutExclude.qHyperCubeDef.qMeasures;
                ...
                function getDimensions() {
                    ...
                    model.getEffectiveProperties().then(function (i) {
                        //console.log(i);
                        var _propiedades = i;
                        var layoutDimensiones = model.layout.boxplotDef.qHyperCube.qDimensionInfo;
                        var arrayDimensiones = _propiedades.boxplotDef.qHyperCubeDef.qDimensions;
                        var numDimensionesAlternativas = _propiedades.boxplotDef.qHyperCubeDef.qLayoutExclude.qHyperCubeDef.qDimensions.length;
                ...
                function getDimensionsAlternativas(item) {
                    ...
                    model.getEffectiveProperties().then(function (i) {
                        var _propiedades = i;
                        var arrayDimensionesAlternativas = _propiedades.boxplotDef.qHyperCubeDef.qLayoutExclude.qHyperCubeDef.qDimensions;
                ...
                function getMedidas() {
                    ...
                    model.getEffectiveProperties().then(function (i) {
                        //console.log(i);
                        var _propiedades = i;
                        var layoutMeasure = model.layout.boxplotDef.qHyperCube.qMeasureInfo;
                        var arrayMeasures = _propiedades.boxplotDef.qHyperCubeDef.qMeasures;
                        var numMeasuresAlternativas = _propiedades.boxplotDef.qHyperCubeDef.qLayoutExclude.qHyperCubeDef.qMeasures.length;
                ...
                function getMeasuresAlternativas(item) {
                    ...
                    model.getEffectiveProperties().then(function (i) {
                        var _propiedades = i;
                        var arrayMeasuresAlternativas = _propiedades.boxplotDef.qHyperCubeDef.qLayoutExclude.qHyperCubeDef.qMeasures;
                ...
                //properties.boxplotDef.elements.outliers.include
                ...
                function getValoresExtremos() {
                    ...
                    model.getEffectiveProperties().then(function (i) {
                        var _propiedades = i;
                        isExtremos = _propiedades.boxplotDef.elements.outliers.include;
                        defer.resolve(isExtremos);
                    })                                        
                    return defer.promise;
                }
                    ...
                    model.getEffectiveProperties().then(function (i) {
                        ...
                        if (showOrdenacion === true) {
                            if (_autoSort == true) {                       
                                ...
                                dfd.resolve(showOrdenacion, _autoSort, orderBy, 'ByNumeric', sortingCriterias)
                            } else {
                                var sortingCriterias = _propiedades.boxplotDef.sorting.sortCriteria;
                                if (sortingCriterias) {
                                    var _autoSort = _propiedades.boxplotDef.sorting.autoSort;
                                    ...
                                    dfd.resolve(orderBy, _autoSort, _initOrden, _sortingBy, sortingCriterias);
                                }
                            }                   
                        } else {                    
                ...
                getDimensionOrden().then(function (showOrdenacion, _autoSort, _initOrden, _sortingBy, _sortingCriterias) {
                ...
                $scope.changeOrden = function (val, autoSort, sortingBy) {
                    ...
                    if (_autoSort == true) {
                        if ($scope.SortCriterias == '') {  
                            var _patches = [
                                {
                                    "qPath": "/boxplotDef/sorting/sortCriteria/qSortByAscii",
                                    "qOp": "add",
                                    "qValue": JSON.stringify(0)
                                },
                                {
                                    "qPath": "/boxplotDef/sorting/sortCriteria/sortByNumeric",
                                    "qOp": "add",
                        ...
                        switch (_sortingBy) {
                            ...
                            case 'ByExpression':
                                var _patches = [
                                    ...
                                    {
                                        "qPath": "/boxplotDef/sorting/sortCriteria/sortByExpression",
                                        "qOp": "replace",
                                        "qValue": JSON.stringify(_value)
                                    }
                                ]
                            ...
                            case 'ByAscii':
                                var _patches = [
                                    ...
                                    {
                                        "qPath": "/boxplotDef/sorting/sortCriteria/sortByAscii",
                                        "qOp": "replace",
                                        "qValue": JSON.stringify(_value)
                                    }
                                ]
